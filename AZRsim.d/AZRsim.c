...
void RxODE_mod_AZRsim_dydt(unsigned int neq, double t, double *__zzStateVar__, double *__DDtStateVar__)
{
double
	C2,
	centr,
...
void RxODE_mod_AZRsim_calc_lhs(double t, double *__zzStateVar__, double *lhs) {
double
	C2,
	centr,
	V2,
